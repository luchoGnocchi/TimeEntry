...
namespace GestorInventarioEmpresas.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        {
            GestorInventarioEmpresasContext context = new GestorInventarioEmpresasContext();
            if (context.Users.ToList().Count == 0)
            {
                context.Roles.Add(new Microsoft.AspNet.Identity.EntityFramework.IdentityRole { Name = "Administrador" });
                context.Roles.Add(new Microsoft.AspNet.Identity.EntityFramework.IdentityRole { Name = "Usuario" });
              
                var admin = new ApplicationUser { UserName = "Admin", Email = "admin@admin.com" };
                _userManager.Create(admin, admin.UserName);
                context.SaveChanges();
                _userManager.AddToRole(admin.Id, "Administrador");
                context.SaveChanges();
            }

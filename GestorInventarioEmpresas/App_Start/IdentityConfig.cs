...
using GestorInventarioEmpresas.BackEnd.Commons.Mailer;
...
namespace GestorInventarioEmpresas
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            return MailerClientUtil.SendMailAsync(new MailerClientUtil.EmailModel
            {
                Recipients = new List<string> { message.Destination },
                Body = message.Body,
                IsBodyHtml = true,

                            ...
                            $.ajax({
                                ...
                                success: function (result) {
                                    ...
                                    if (result.empresas != undefined) {
                                        ...
                                        htmlSelectEmpresa = '  <select class="sselect2-container select2 form-control" id="cmbEmpresa"  style="background: white;min-width: 104px">';
